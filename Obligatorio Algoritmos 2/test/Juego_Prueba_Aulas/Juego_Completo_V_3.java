...
public class Juego_Completo_V_3 {
    @Test
	...
	public void testTramosError1() {
		...
		//Peso invalido
		assertEquals(Retorno.Resultado.ERROR_1 , sistema.registrarTramo(-32.3105104,-58.0759192, -32.3105200,-58.0759200, -3).resultado);
		assertEquals(Retorno.Resultado.ERROR_1, sistema.registrarTramo(-32.3105104,-58.0759192, -32.3105200,-58.0759192, 0).resultado);		
	...
	public void testTramosError3() {
		...
		// Tramo OK
		assertEquals(Retorno.Resultado.OK, sistema.registrarTramo(-32.3105104,-58.0759192, -32.3105200,-58.0759200, 80).resultado);
		//Tramo duplicado
		assertEquals(Retorno.Resultado.ERROR_3, sistema.registrarTramo(-32.3105104,-58.0759192, -32.3105200,-58.0759200, 100).resultado);
	...
	public void testNodosCriticos(){
		...
		assertEquals(Retorno.Resultado.OK, r.resultado);
		boolean pruebaNodoCoords = "-3.0;-3.0|-2.0;-2.0".equals(r.valorString)||"-2.0;-2.0|-3.0;-3.0".equals(r.valorString);
